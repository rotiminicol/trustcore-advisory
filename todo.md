# Motion-led TRUSTCORE ADVISORY revision

- [x] Define the cinematic motion language, pacing, and mobile fallback behaviour.
- [x] Generate a bespoke looping hospitality film and a complementary operations-detail motion asset. The secondary film is deferred because today’s free video quota was reached.
- [x] Build an immersive preloader and video-led hero sequence.
