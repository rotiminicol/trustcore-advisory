...
export default function Home() {
  return <SiteShell tone="dark"><main className="home-refined">
    <section className="rf-hero" aria-labelledby="rf-home-heading">
      <div className="rf-hero__media" aria-hidden="true"><video autoPlay muted loop playsInline poster="https://files.manuscdn.com/user_upload_by_module/session_file/310519663721754241/VIzzEVFOcPJVWyZM.jpg"><source src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663721754241/ugKhsfhtDIZOATXF.mp4" type="video/mp4" /></video><div /></div><div className="rf-hero__grain" aria-hidden="true" />
