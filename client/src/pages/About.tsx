...
export default function About() {
  return <SiteShell><main className="about-refined">
    ...
    <section className="ab-context"><div className="ab-context__image"><img src="/manus-storage/trustcore-service-teams_91a3aa03.jpg" alt="Hospitality professionals in a focused pre-service coordination session" /></div><div className="ab-context__content motion-reveal"><img src="/manus-storage/trustcore-monogram_7213fa8a.png" alt="Trustcore Advisory monogram" className="ab-context__seal" /><PageEyebrow chapter="C">The work today</PageEyebrow><h2>Advisory that sees the <em>whole operating picture.</em></h2><p>TRUSTCORE supports businesses remotely and worldwide, bringing a practical view of hospitality operations, customer experience, security awareness, team capability, and business improvement.</p><Link href="/expertise" className="ab-context__link">Explore the areas of expertise <ArrowRight /></Link></div></section>
